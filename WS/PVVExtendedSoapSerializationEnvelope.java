...
public class PVVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PVVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PVVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PVVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PVVDateTimeConverter dateTimeConverter = new PVVStandardDateTimeConverter();

    public PVVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PVVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PVVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PVVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PVVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PVVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
