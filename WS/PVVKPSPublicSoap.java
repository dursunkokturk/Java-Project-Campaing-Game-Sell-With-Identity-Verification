...
public class PVVKPSPublicSoap
{
    ...
    public PVVKPSPublicSoap(){}

    public PVVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PVVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PVVExtendedSoapSerializationEnvelope envelope= new PVVExtendedSoapSerializationEnvelope(PVVExtendedSoapSerializationEnvelope.VER11);
